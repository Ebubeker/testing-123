    ...
    <>
      <section className="services-area">
          ...
          <div className="row justify-content-center">
            {services.length
              ...
              : Array.from({ length: 3 }).map((_, indx) => (
                  <div className="col-lg-4 col-md-6 col-sm-10" key={indx}>
                    <div
                      className="services-item wow fadeInUp"
                      style={{ minHeight: "350px" }}
                      data-wow-delay=".4s"
        ...
        {services.length < limit ? null : (
          <div className="justify-center" onClick={() => setLimit(limit + 3)}>
...
export default ServicePaginated;
